...
<div class="container">
      ...
      <div  class="form">
        <form id="contactform" method="POST"> 
          ...
          <input id="email" name="email" placeholder="email" required="" type="email" value="<?php if(isset($_POST['signup'])) { echo $_POST['email']; } ?>"> 
  ...
  <div class="login-help">
    <a href="login.php">Already have a account?</a><br><br>
  </div>
</div>      
</div>
